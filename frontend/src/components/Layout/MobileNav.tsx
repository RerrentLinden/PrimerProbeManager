...
export default function MobileNav() {
  return (
    <nav className="lg:hidden fixed bottom-0 inset-x-0 bg-metal-sidebar border-t border-lab-border shadow-panel z-40">
          ...
          <NavLink
            ...
            className={({ isActive }) =>
              `flex flex-col items-center gap-0.5 px-3 py-1.5 text-xs font-medium transition-colors ${
                isActive ? 'text-lab-accent drop-shadow-[0_0_6px_rgba(74,158,255,0.5)]' : 'text-lab-muted'
              }`
            }
          >
